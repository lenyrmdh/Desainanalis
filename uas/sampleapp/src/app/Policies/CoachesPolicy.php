...
class CoachesPolicy
{
    ...
    {
        return $user->can('view_any_coaches');
    }
    ...
    {
        return $user->can('create_coaches');
    }
    ...
    {
        return $user->can('update_coaches');
    }
    ...
    {
        return $user->can('delete_coaches');
    }
    ...
    {
        return $user->can('delete_any_coaches');
    }
     ...
     */
    public function replicate(User $user, Coaches $coaches): bool
    {
